...
Copy original titus/moktar files to the titus/moktar subfolders. Copy opentitus_0.8.0.dge, titus.conf (or titus_moktar.conf, rename it to titus.conf to play Moktar) and titus/moktar folders to the same folder on the card (such as /local/), and launch it via Applications/Explorer.
